...
- 2d0da5a: FEATURE: Added instrumentation support and Sentry integration tests.
...
- 2d0da5a: FEATURE: Added support for `node:22` and make it the default.
  - Contributed by [@sukeshpabolu](https://github.com/sukeshpabolu).

### Patch Changes

- 2d0da5a: FEATURE: Added support for the HTTP `PATCH` method.
